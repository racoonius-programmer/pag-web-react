...
export const initUserDB = (): void => {
    ...
    if (localStorage.getItem("usuarios")) {
        console.log("DEV: Base de datos de usuarios ya existe en localStorage. Omitiendo inicialización.");
        return;
    }
    ...
    console.log("DEV: Base de datos de usuarios inicializada en localStorage.");
};